...
> aurora execute 'dsim -F filelist.txt -L lpm_ver +acc+b -waves waves.vcd'
Note: `-L lpm_ver` is needed at the elaboration time, it will instruct DSim to look for the component in the library called lpm_ver.
